...
export default function TechKanban() {
    ...
    const fetchTickets = async () => {
        try {
            const res = await axios.get((import.meta.env.VITE_API_URL ?? 'http://localhost:8000') + '/api/repair/tickets', {
    ...
    const handleComplete = async () => {
        ...
        try {
            await axios.post((import.meta.env.VITE_API_URL ?? 'http://localhost:8000') + '/api/repair/complete', {
