    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[var(--bg-primary)]/50 relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 relative z-10 flex flex-col items-center">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-[var(--text-primary)] text-center">Mobile ERP</h1>
          <p className="text-sm text-gray-500 dark:text-[var(--text-secondary)] text-center mt-2">Enterprise Resource Planning System</p>
        </div>

        <div className="w-full bg-white dark:bg-[var(--bg-tertiary)] rounded-2xl shadow-xl border border-gray-100 dark:border-[var(--border-secondary)] overflow-hidden flex justify-center p-6">
