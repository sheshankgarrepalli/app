...
function LaborRatesSetup() {
    ...
    const fetchRates = async () => {
        try {
            const res = await axios.get('http://localhost:8000/api/admin/rates', {
    ...
    return (
        <div className="p-8 max-w-5xl">
            ...
            <button
                onClick={() => axios.post('http://localhost:8000/api/admin/rates/seed', {}, { headers: { Authorization: `Bearer ${token}` } }).then(fetchRates)}
